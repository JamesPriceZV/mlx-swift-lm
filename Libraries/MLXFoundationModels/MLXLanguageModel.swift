...
public struct MLXLanguageModel: FoundationModels.LanguageModel, Sendable {
    ...
    public struct Executor: LanguageModelExecutor, Sendable {
        ...
        enum GenerationEvent: Sendable {
            ...
            case updateMetadata([String: GeneratedContent], entryID: String?)
            case updateUsage(
        ...
        static func emitMetadata(
            _ values: [String: any ConvertibleToGeneratedContent], entryID: String?,
            into channel: LanguageModelExecutorGenerationChannel
        ) async {
            generationObserver?(
                .updateMetadata(values.mapValues(\.generatedContent), entryID: entryID))
