...
let package = Package(
    ...
    dependencies: [
        // Pinned owned fork carries reviewed, pipeline-derived Metal
        // threadgroup limits required by current Apple GPU families.
        .package(
            url: "https://github.com/JamesPriceZV/mlx-swift",
            revision: "7be237f2fb00b854448a1d3b92b364a2e9857ff3"
        ),
